...
exports.requestCancellation = asyncHandler(async (req, res) => {
    const booking = await roomBookingService.requestCancellation(req.params.id, req.user);
...
exports.checkAvailability = asyncHandler(async (req, res) => {
    ...
    const result = await roomBookingService.checkAvailability(roomNumber, checkInDate, checkOutDate);
